...
public final class Distribution {
    ...
    private static Random random;   //generador de n° pseudo random
    private static long seed;       //semilla para generar n° pseudo random

    static {                        //inicializador
        //seed = 1600985377042l;    SEMILLA TEST 1 PARA REPLICAR               
        seed = System.currentTimeMillis();    //generamos la semilla
        random = new Random(seed);            //generamos valores randoma en base a la semilla
    }

    
    private Distribution() {  //no inicializar
    }

  /*NOTA: Establece la semilla del generador de números pseudo randoms. Este método permite producir la misma secuencia de números "aleatorios" para cada ejecución del programa. Utilizar para testeos */
